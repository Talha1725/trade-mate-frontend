...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-pointer items-center gap-1.5 rounded-md py-1 pr-1 pl-1.5 text-sm outline-hidden select-none focus:bg-white/10 focus:text-white not-data-[variant=destructive]:focus:**:text-white data-disabled:pointer-events-none data-disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4 *:[span]:last:flex *:[span]:last:items-center *:[span]:last:gap-2 hover:text-white",
        className
      )}
      {...props}
    >
      ...
      <SelectPrimitive.ItemIndicator
        render={
          <span className="pointer-events-none absolute right-8 flex size-4 items-center justify-center" />
        }
      >
